...
public static class AssinaturaTreinadorErrors
{
    ...
    public static Error OffboardingNecessario => new("offboarding_necessario", "Não é possível cancelar o plano com alunos ativos vinculados. Desvincule os alunos antes de cancelar.");
}
