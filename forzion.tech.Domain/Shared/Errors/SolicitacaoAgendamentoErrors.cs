...
public static class SolicitacaoAgendamentoErrors
{
    ...
    public static Error TransicaoNaoSuportada => Error.Conflict("solicitacao_agendamento.transicao_nao_suportada", "Esta transição de status não é suportada por esta operação.");
