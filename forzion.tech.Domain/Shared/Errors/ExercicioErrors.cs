...
public static class ExercicioErrors
{
    ...
    public static Error ComoExecutarMuitoLongo => new("exercicio.como_executar_muito_longo", "As instruções de execução devem ter no máximo 2000 caracteres.");
    public static Error VideoUrlInvalida => new("exercicio.video_url_invalida", "O link do vídeo deve ser um vídeo do YouTube válido.");
}
