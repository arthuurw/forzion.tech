...
public static class PacoteErrors
{
    ...
    public static Error DuracaoObrigatoriaParaPublico => Error.Validation("pacote.duracao_obrigatoria_para_publico", "A duração em minutos é obrigatória para tornar o pacote público.");
    public static Error DuracaoMinutosInvalida => Error.Validation("pacote.duracao_minutos_invalida", "A duração em minutos deve estar entre 1 e 480.");
