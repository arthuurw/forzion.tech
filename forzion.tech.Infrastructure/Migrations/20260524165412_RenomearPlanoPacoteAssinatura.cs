...
namespace forzion.tech.Infrastructure.Migrations
{
    ...
    public partial class RenomearPlanoPacoteAssinatura : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("ALTER TABLE homolog.planos_plataforma RENAME CONSTRAINT pk_planos_treinador TO pk_planos_plataforma;");
            migrationBuilder.Sql("ALTER TABLE homolog.pacotes RENAME CONSTRAINT pk_pacotes_aluno TO pk_pacotes;");
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT pk_assinaturas TO pk_assinaturas_aluno;");

            // --- pacotes: rename internal FK and index ---
            migrationBuilder.Sql("ALTER TABLE homolog.pacotes RENAME CONSTRAINT fk_pacotes_aluno_treinadores_treinador_id TO fk_pacotes_treinadores_treinador_id;");
            ...
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT fk_assinaturas_alunos_aluno_id TO fk_assinaturas_aluno_alunos_aluno_id;");
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT fk_assinaturas_pacotes_aluno_pacote_aluno_id TO fk_assinaturas_aluno_pacotes_pacote_id;");
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT fk_assinaturas_treinadores_treinador_id TO fk_assinaturas_aluno_treinadores_treinador_id;");
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT fk_assinaturas_vinculos_treinador_aluno_vinculo_id TO fk_assinaturas_aluno_vinculos_treinador_aluno_vinculo_id;");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT fk_assinaturas_aluno_alunos_aluno_id TO fk_assinaturas_alunos_aluno_id;");
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT fk_assinaturas_aluno_pacotes_pacote_id TO fk_assinaturas_pacotes_aluno_pacote_aluno_id;");
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT fk_assinaturas_aluno_treinadores_treinador_id TO fk_assinaturas_treinadores_treinador_id;");
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT fk_assinaturas_aluno_vinculos_treinador_aluno_vinculo_id TO fk_assinaturas_vinculos_treinador_aluno_vinculo_id;");
            ...
            migrationBuilder.Sql("ALTER TABLE homolog.pacotes RENAME CONSTRAINT fk_pacotes_treinadores_treinador_id TO fk_pacotes_aluno_treinadores_treinador_id;");
            migrationBuilder.RenameIndex(
            ...
            // --- Revert primary keys ---
            migrationBuilder.Sql("ALTER TABLE homolog.planos_plataforma RENAME CONSTRAINT pk_planos_plataforma TO pk_planos_treinador;");
            migrationBuilder.Sql("ALTER TABLE homolog.pacotes RENAME CONSTRAINT pk_pacotes TO pk_pacotes_aluno;");
            migrationBuilder.Sql("ALTER TABLE homolog.assinaturas_aluno RENAME CONSTRAINT pk_assinaturas_aluno TO pk_assinaturas;");
