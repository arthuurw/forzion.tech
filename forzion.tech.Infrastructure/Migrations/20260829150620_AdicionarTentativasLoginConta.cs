...
namespace forzion.tech.Infrastructure.Migrations
{
    ...
    public partial class AdicionarTentativasLoginConta : Migration
    {
        ...
        {
            // lint-migrations:allow — o índice UNIQUE em tentativas_login_conta.conta_id recai
            // sobre tabela CRIADA nesta mesma migration (sem linhas pré-existentes), logo não há
            // risco de falha por duplicata; o lint não distingue tabela nova de tabela populada.
