...
public class PacoteAlunoConfiguration : IEntityTypeConfiguration<PacoteAluno>
{
    public void Configure(EntityTypeBuilder<PacoteAluno> builder)
    {
        builder.ToTable("pacotes_aluno");
