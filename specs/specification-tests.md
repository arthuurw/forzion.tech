...
- Backend: **2164** unit (`Category!=Integration`, reconferido 2026-06-13 — cresceu com a feature sessao-refresh; era 2088 em 06-12, baseline 06-06 era 1843) + integração/Testcontainers ≥**96** (cresceu com sessao-refresh: `RefreshTokenRepositoryTests` — round-trip, UQ token_hash, cascade, GC `LimparExpiradas`, purga `ExcluirPorContaId`; roda no CI) — verde. Frontend: **771** (vitest 3 projects, reconferido 2026-06-13; era 729 em 06-12, baseline 06-06 era 631) — verde. Matriz de sessão (rotação feliz, **reuse→revoga família+401**, idle vs absolute, troca-senha revoga tudo, anonimização purga famílias; FE: interceptor refresh+retry, coalescência, middleware leniência com refresh) co-localizada nos respectivos handlers/rotas. Playwright E2E: suíte completa só roda no CI Linux (creds `E2E_*` + browsers); validação local cobriu smoke+critical públicos/admin (público 4/4, admin 3/3 — [specification-local-ci-repro] §4); aluno/treinador bloqueados local. Alguns specs com seletor frágil — ver `.specs/qa`.
