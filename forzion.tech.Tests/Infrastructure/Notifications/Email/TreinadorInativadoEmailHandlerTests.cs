...
public class TreinadorInativadoEmailHandlerTests
{
    ...
    {
        var conta = Conta.Criar(EmailVO.FromDatabase("bruno@example.com"), "hash", TipoConta.Treinador, DateTime.UtcNow).Value;
        var treinador = Treinador.Criar(conta.Id, "Bruno", DateTime.UtcNow).Value;
