...
public class AssinaturaAlunoReativadaEmailAlunoHandlerTests
{
    private readonly Mock<IAlunoRepository> _alunoRepo = new();
    private readonly Mock<IContaRepository> _contaRepo = new();
    private readonly Mock<IEmailService> _emailService = new();
    private readonly Mock<IPlanoNotificationPolicy> _planoPolicy = new();
    private readonly Mock<ILogger<AssinaturaAlunoReativadaEmailAlunoHandler>> _logger = new();
    private readonly IOptions<AppSettings> _appSettings;
    private readonly AssinaturaAlunoReativadaEmailAlunoHandler _handler;
    ...
    public AssinaturaAlunoReativadaEmailAlunoHandlerTests()
    {
        ...
        _handler = new AssinaturaAlunoReativadaEmailAlunoHandler(
            _alunoRepo.Object, _contaRepo.Object,
            _emailService.Object, _planoPolicy.Object, _appSettings, _logger.Object);
    }
    ...
    public async Task HandleAsync_AlunoComEmail_UsaEmailDoAluno()
    {
        ...
        _emailService.Verify(e => e.EnviarAsync(
            "maria@aluno.com",
            It.Is<string>(s => s.Contains("reativada")),
            It.Is<string>(html => html.Contains("Maria") && html.Contains("reativada")),
    ...
    public async Task HandleAsync_LinkPortalApontaParaFrontendBaseUrl()
    {
        ...
        _emailService.Verify(e => e.EnviarAsync(
            It.IsAny<string>(),
            It.IsAny<string>(),
            It.Is<string>(html => html.Contains("https://app.forzion.tech/aluno/assinatura")
