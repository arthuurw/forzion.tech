...
public class AlunoRegistradoWhatsAppHandlerTests
{
    ...
    private static readonly AlunoRegistradoEvent Evento =
        new(AlunoId, Guid.NewGuid(), "Maria", "maria@teste.com", TestData.Agora);

    public AlunoRegistradoWhatsAppHandlerTests()
    {
    ...
    [Fact]
    public async Task HandleAsync_AlunoComTelefone_EnviaTemplateBemVindoAluno()
    {
