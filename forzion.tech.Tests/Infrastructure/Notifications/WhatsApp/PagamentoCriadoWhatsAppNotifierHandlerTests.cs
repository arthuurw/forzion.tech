...
public class PagamentoCriadoWhatsAppNotifierHandlerTests
{
    ...
    private readonly Mock<ILogger<PagamentoCriadoWhatsAppNotifierHandler>> _logger = new();
    private readonly IOptions<AppSettings> _appSettings;
    private readonly PagamentoCriadoWhatsAppNotifierHandler _handler;
    ...
    private static readonly PagamentoCriadoEvent Evento = new(
        Guid.NewGuid(), AssinaturaId, 149.90m, MetodoPagamento.Pix, TestData.Agora);

    public PagamentoCriadoWhatsAppNotifierHandlerTests()
    {
        ...
        _handler = new PagamentoCriadoWhatsAppNotifierHandler(
            _assinaturaRepo.Object, _alunoRepo.Object,
            _notifier.Object, _planoPolicy.Object, _appSettings, _logger.Object);
    }
    ...
    [Fact]
    public async Task HandleAsync_AlunoComTelefone_EnviaTemplateCobrancaDisponivel()
    {
        ...
        _notifier.Verify(n => n.SendTemplateAsync(
            ...
            It.Is<WhatsAppTemplateMessage>(m =>
                m.Name == "cobranca_disponivel" &&
                m.BodyParameters.Contains("Maria") &&
                m.BodyParameters.Contains("149,90") &&
                m.BodyParameters.Any(p => p.Contains("Pix")) &&
    ...
    [Fact]
    public async Task HandleAsync_MetodoCartao_TemplateContemCartao()
    {
        ...
        _notifier.Verify(n => n.SendTemplateAsync(
            ...
            It.Is<WhatsAppTemplateMessage>(m =>
                m.Name == "cobranca_disponivel" &&
                m.BodyParameters.Any(p => p.Contains("cartão"))),
            It.IsAny<CancellationToken>()),
            Times.Once);
    }
