...
public static class PromptInjectionPatterns
{
    ...
    [
        ...
        new(@"\bDAN\b|\bdo anything now\b", RegexOptions.IgnoreCase | RegexOptions.Compiled),
        new(@"(?:reveal|show|print|repeat|tell\s+me)\s+(?:your|the)\s+(?:system\s+)?(?:prompt|instructions?)", RegexOptions.IgnoreCase | RegexOptions.Compiled),
